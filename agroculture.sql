...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 09, 2023 at 02:16 PM
...
(19, 'Good One..,', 'ThePhenom', 'profile0.png', '2018-02-25 13:09:54');
...
(3, 'Vaibhav A K', 'buy', '$2y$10$CRyg7IP1PtsToXeNONbU3ekDsihD1NqCv85.atw.is8R0xJjT0x92', 'f29c21d4897f78948b91f03172341b7b', 'vinod@asd.com', '7852036971', 'zbjhxchjshsjajajkjl', 0);
...
(4, 'Vaibhav A K', 'asdf', '$2y$10$/lUwPtsgclLyz0fYVuisC.uO4D7vyktkVgKndvmgo.02filydg4om', '94c7bb58efc3b337800875b5d382a072', 'vinod@asd.com', '7852036971', 'zbjhxchjshsjajajkjl', 1, 0, 'png', 0);
...
(3, 27, 'Apple', 'Fruit', '<p>Green hymalayan Apple</p>\n', 500, 'GreenApple4.jpg', 1),
(3, 28, 'Ladyfinger', 'Vegetable', '<p>Its veggie</p>\r\n', 1000, 'Ladyfinger5.jpg', 1),
(3, 29, 'Bajra', 'Grains', '<p>bajre di rti</p>\r\n', 400, 'Bajra4.jpg', 1),
(3, 30, 'Chikoo', 'Fruit', '<p>Sapota(Chikoo)</p>\n', 400, 'Sapota(Chikoo)5.jpg', 1);
...
(2, 4, 27, 'Vaibhav A K', 'bgk', '+917852036971', 'vinod@asd.com', '587101', 'zbjhxchjshsjajajkjl');
...
ALTER TABLE `blogfeedback`
  ADD UNIQUE KEY `blogId` (`blogId`,`comment`,`commentUser`,`commentPic`,`commentTime`);
